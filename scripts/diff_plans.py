...
def main() -> None:
    """Diff the Official or a Notable map with the the Baseline map."""
    ...
    for label in [
        ...
        if not validate_plans([compare_plan.districts(), baseline_plan.districts()]):
            print("Warning: Plans have different # of blocks!")
