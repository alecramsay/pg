...
"""
Update display settings for editing DRA maps.

For example:

$ scripts/update/display_settings.py -s NC

For documentation, type:

$ scripts/update/display_settings.py -h
...
def parse_args() -> Namespace:
    parser: ArgumentParser = argparse.ArgumentParser(
        description="Update display settings for editing DRA maps."
    )
